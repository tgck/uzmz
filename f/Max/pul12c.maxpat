...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 673.0, 346.0, 50.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 673.0, 292.0, 81.0, 20.0 ],
					"text" : "random 1000"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 493.0, 407.0, 32.5, 20.0 ],
					"text" : "t b l"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 493.0, 379.0, 111.0, 20.0 ],
					"text" : "sprintf %f\\, %f 1333"
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 662.0, 248.0, 50.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 546.0, 231.0, 105.0, 27.0 ],
					"presentation_rect" : [ 611.0, 194.0, 0.0, 0.0 ],
					"setminmax" : [ 0.0, 1.0 ],
					"setstyle" : 3
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 586.0, 346.0, 50.0, 20.0 ],
					"presentation_rect" : [ 586.0, 344.0, 0.0, 0.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 586.0, 315.0, 41.0, 20.0 ],
					"presentation_rect" : [ 586.0, 315.0, 0.0, 0.0 ],
					"text" : "/ 100."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 586.0, 292.0, 75.0, 20.0 ],
					"presentation_rect" : [ 586.0, 292.0, 0.0, 0.0 ],
					"text" : "random 100"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 511.0, 157.0, 74.0, 31.0 ],
					"text" : "0.78, 0.95 705"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 511.0, 201.0, 59.0, 20.0 ],
					"text" : "line 1. 20"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 493.0, 315.0, 41.0, 20.0 ],
					"text" : "/ 100."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 493.0, 292.0, 75.0, 20.0 ],
					"text" : "random 100"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 478.0, 257.0, 59.5, 20.0 ],
					"text" : "t b b b b"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 493.0, 346.0, 50.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 144.0, 120.0, 68.0, 20.0 ],
					"text" : "cycle~ 400"
				}
